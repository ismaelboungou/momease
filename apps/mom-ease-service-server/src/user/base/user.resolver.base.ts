...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [CommunityForum], { name: "communityForums" })
  async findCommunityForums(
    @graphql.Parent() parent: User,
    @graphql.Args() args: CommunityForumFindManyArgs
  ): Promise<CommunityForum[]> {
    const results = await this.service.findCommunityForums(parent.id, args);
  ...
  @graphql.ResolveField(() => [ParentingTip], { name: "parentingTips" })
  async findParentingTips(
    @graphql.Parent() parent: User,
    @graphql.Args() args: ParentingTipFindManyArgs
  ): Promise<ParentingTip[]> {
    const results = await this.service.findParentingTips(parent.id, args);
