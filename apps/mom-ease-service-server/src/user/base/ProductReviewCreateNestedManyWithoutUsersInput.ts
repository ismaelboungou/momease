...
@InputType()
class ProductReviewCreateNestedManyWithoutUsersInput {
...
export { ProductReviewCreateNestedManyWithoutUsersInput as ProductReviewCreateNestedManyWithoutUsersInput };
